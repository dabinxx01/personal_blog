        ...
        table.on('tool(categorytable)', function(obj){
            ...
            // 更新事件
                ...
                {;
                    ...
                    $("#updisdel0").attr("checked","checked");
                    $("#updisdel0 + div").addClass("layui-form-radioed");
                    $("#updisdel0 + div").find("i").addClass("layui-anim-scaleSpring");
                } else {
                    $("#updisdel0").removeAttr("checked");
                    $("#updisdel1").attr("checked","checked");
                    $("#updisdel1 + div").addClass("layui-form-radioed");
                    $("#updisdel1 + div").find("i").addClass("layui-anim-scaleSpring");
                }
