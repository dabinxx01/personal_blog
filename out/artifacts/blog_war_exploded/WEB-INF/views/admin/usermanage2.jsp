    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'email', title:'邮箱', width:200, edit: 'text', template: function(res){
                        return '<em>'+ res.email +'</em>'
                    }}
                ,{field:'password', title:'密码', width:200, edit: 'text', sort: true}
                ,{field:'headpic', title:'头像', width:300}
        ...
        table.on('tool(test)', function(obj){
            ...
            // 更新用户事件
                ...
                {
                    $("#updper1[name=permission][value=true]").attr("checked", false);
                    $("#updper0[name=permission][value=false]").attr("checked", true );
                }else{
                    $("#updper0[name=permission][value=false]").attr("checked", false );
                    $("#updper1[name=permission][value=true]").attr("checked", true);
                }
